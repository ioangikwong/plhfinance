...
const posts = [
    ...
    },
    {
        ...
        image: "/blog/proches-aidants.jpg"
    },
    {
            ...
            <section className="py-24 sm:py-32 bg-white">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                        {posts.map((post) => (
                            <article key={post.slug} className="flex max-w-xl flex-col items-start justify-between bg-white border border-slate-100 rounded-3xl overflow-hidden hover:shadow-xl hover:border-primary/20 transition-all group">
                                ...
                                <div className="p-8 flex flex-col flex-1">
                                    ...
                                    <div className="group relative mt-6 flex-1">
